...
#Encapsulation de Widget autonome
...
class QColorPicker(QWidget):
    ...
    def __create_channel(self, title_text, control, color, fixed_widget_width):
        ...
        control.valueChanged.connect(self.colorChanged)
    ...
    def color(self, value):
        ...
        self.__blue_control.value = value.green()
...
class ColorPickerApplication(QMainWindow):
    ...
    def __init__(self):
        ...
        self.__central_widget = QWidget()
        self.centralWidget.add_widget(central_layout)
        
        color_pickers = [QColorPicker() for _ in range(3)]
